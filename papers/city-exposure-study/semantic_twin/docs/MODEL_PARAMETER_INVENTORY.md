...
| Foliage and bodies | 0.0002 m leaf; body spacing/radii/remesh settings | `foliage.py`, `bystander_geometry.py` | material/bystander | canonical/default | yes | none | Includes body-placement geometry. |
