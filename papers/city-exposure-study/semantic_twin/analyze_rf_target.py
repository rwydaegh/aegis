"""Ask Gemini 3.6 Flash what an RF-selected panorama crop contains."""
...
from semantic_twin.vision.rf_agent import GEMINI_MODEL, RfTargetContext, run_gemini_cli
...
def main(argv: list[str] | None = None) -> None:
    ...
    run = run_gemini_cli(args.image, context, model=args.model, timeout_s=args.timeout_s)
    encoded = json.dumps(run.as_dict(), indent=2)
