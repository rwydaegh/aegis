...
bodies at $74.0\,$Gbps, the MCS28 sum-cap, by
...
MCS28 cap of $74.0\,$Gbps, within $0.0\,\%$ of unconstrained-and-non-compliant
...
ZF leaves enough SINR headroom above the linear MCS28 clip
...
\begin{figure*}[!t]
  ...
  the dual ascent saturate the MCS28 sum-cap at $74.0\,$Gbps; both
...
the receiver floor and the projection step at exit. The MCS28 cap
...
Sum-rate sits at the MCS28 sum-cap of $74.0\,$Gbps across the full
...
\begin{figure}[!t]
  ...
  Green dotted: mean sum-rate, flat at the MCS28 sum-cap of
...
algorithmic. The per-stream MCS28 cap of $7.4\,$bps/Hz clips the
...
detected-body input set at the MCS28 sum-cap of $74.0\,$Gbps. The
