...
10. If meaningful project files changed, follow the repository's Git workflow. Stage only the files owned by the task. Use a feature branch and squash-merge PR for changes spanning five or more files. Report the final commit or PR and any remaining dirty state.
