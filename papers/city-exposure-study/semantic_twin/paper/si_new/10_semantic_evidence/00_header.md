% NEXT: The image-labeling pass uses two models with separate roles. Mask2Former with the
% NEXT: 65-class Mapillary Vistas vocabulary assigns one street-scene object class to every pixel. It
% NEXT: therefore supplies the complete object map and identifies small objects such
...
% NEXT: material labels needed inside such broad object classes. The production
...
% NEXT: matching object in the view. The complete prompt list and its object, material,
