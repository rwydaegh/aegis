...
Outputs
-------
- artifacts/eta/<phantom_name>/eta.npz with keys: eta, centroids, normals
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out", type=str, default=None, help="Output dir (default: artifacts/eta/<name>/)")
...
def main() -> None:
    ...
    root = infer_repo_root()
    out_dir = Path(args.out) if args.out is not None else (root / "artifacts" / "eta" / phantom)
