% PREV: \begin{table}[!t]
% PREV:   \caption{Atlas-to-geometric change in route quantiles of normalized
% PREV:   whole-body SAR. Positive values mean that the atlas result is larger.}
% PREV:   \label{tab:si-material-control}
% PREV:   \centering
% PREV:   \begin{tabular}{lrrr}
% PREV:     \toprule
% PREV:     Site & q10 (dB) & q50 (dB) & q90 (dB) \\
% PREV:     \midrule
% PREV:     Madrid & 0.233 & 0.249 & 0.269 \\
% PREV:     Mexico City & 24.84 & -0.158 & 0.104 \\
% PREV:     \bottomrule
% PREV:   \end{tabular}
% PREV: \end{table}
...
- Explains the apparently large Mexico q10 without hiding it.
