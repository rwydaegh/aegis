...
% PREV: Power Density (IPD) multiplied by normal-incidence transmission, the positive
% PREV: incidence cosine, and an ambient-occlusion factor. For
...
% PREV: surface yields a generalized Cauchy whole-body identity governed by a
% PREV: single geometry-dependent scalar. A layered transmission term captures the sub-6~GHz
...
% PREV: phantom, Sim4Life FDTD, and dosimetry literature across 108
