...
:class:`NextEventGather` is the estimator that consumes it. The gather is
transport rather than illumination and belongs beside the tracer once the
transport layer becomes its own package. It is here because it has always been
here, and moving it and the sources apart in the same pass would have been two
changes at once.
"""
