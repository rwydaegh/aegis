...
% NEXT: through whole-body and local basic restrictions in the \gls{ICNIRP} 2020
% NEXT: guidelines~\cite{ICNIRP2020}, IEC/IEEE~63195, and IEEE~C95.1. Whole-body
% NEXT: exposure is expressed as mass-averaged \gls{SAR}. The local metric changes
% NEXT: from \gls{psSAR10g} below 6~GHz to surface-averaged \gls{APD} above 6~GHz. Direct evaluation uses
...
% NEXT: evaluated in under $10$~ms on a modern GPU at any
