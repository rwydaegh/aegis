...
def figure_convergence() -> None:
    ...
    right.legend(loc=LEGEND_UPPER_LEFT, fontsize=7.0)
...
def figure_law() -> None:
    ...
    left.legend(loc=LEGEND_UPPER_LEFT, fontsize=7.0)
...
def plot_masonry_grating(figure_name: str) -> None:
    apply_monograph_style(mode="png")
    selected = FIGURES_BY_NAME if figure_name == "all" else {figure_name: FIGURES_BY_NAME[figure_name]}
