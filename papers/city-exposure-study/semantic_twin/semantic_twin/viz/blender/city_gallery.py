...
from semantic_twin.viz.blender.showcase_scene import import_tiles  # noqa: E402
...
def render_site(site: str, tiles_dir: pathlib.Path, args: Any) -> None:
...
def render_gallery(args: Any) -> None:
