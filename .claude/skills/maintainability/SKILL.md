...
This is the ambitious part. Tier 1 alone may be 5-15 files. Use the `superpowers:dispatching-parallel-agents` skill to send independent file refactors to subagents. Each subagent gets:
