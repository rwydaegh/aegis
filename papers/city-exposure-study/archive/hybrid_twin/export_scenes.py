...
osm_buildings.json anchor):
  ...
  scenes/photo/scene.xml   naive photogrammetry: the raw Inhouse mesh, one material.
...
def run_export(args):
    ...
    print("[bvh] collecting inhouse triangles...", flush=True)
    ...
    (ph / "scene.xml").write_text(scene_xml(shapes, comments=[
        ...
        "The raw Inhouse Photorealistic 3D Tiles mesh, unsegmented, one material."
