...
% NEXT: unpolarized plane-wave illumination of intensity $\IPD$ on tissue
% NEXT: with normal-incidence transmission $T_0$, the direction-averaged
% NEXT: whole-body absorbed power is
