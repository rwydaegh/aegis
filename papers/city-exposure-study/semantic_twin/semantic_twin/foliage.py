...
``MATERIAL_SUBSTITUTION`` in ``propagation/semantic_binding.py``. That
substitution turns a tree into a smooth slab of timber with an RMS height of
0.05 mm, which is radio-smooth at every frequency in this study. This module
replaces it.
...
class FoliageTracer:
    ...
    def trace(self, origin: np.ndarray, models: dict[str, Any]) -> FoliageTraceResult:
        ...
        from .propagation.directions import sample_sphere
