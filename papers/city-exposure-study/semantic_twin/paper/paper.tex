...
trace represents every possible source position and co-located photographs
cover the early interaction surfaces. The method was applied at 15\,GHz to 880
...
Monte Carlo error. Image-based facade materials shifted distribution
medians by 0.024, 0.029, and 0.022\,dB. A geometry-specific diffraction bound
...
meter costs 0.5 and 0.3\,dB. The isotropic control loses only 0.05\,dB, and
...
illumination law with no antenna. Section~\ref{sec:results} shows later that a
...
at one carrier with static upright people, and it used the superseded
six-interaction configuration. Its mechanism is still informative: the facades
had already changed the arriving elevation distribution before a crowd blocked
it. The 1.4 and 1.0\,dB shifts are paired Korenmarkt results rather than
city-independent corrections.
