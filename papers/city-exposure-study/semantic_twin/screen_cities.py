...
CANDIDATES = [
    Candidate("korenmarkt", "Korenmarkt", "Belgium", 51.055, 3.722, "medieval brick square, car track capture, acquired"),
    Candidate("milan_duomo", "Piazza del Duomo", "Italy", 45.4642, 9.19, "monumental stone piazza, cathedral pinnacle field, acquired"),
    Candidate("brussels_grandplace", "Grand-Place", "Belgium", 50.84673, 4.35247, "fully enclosed guildhall square, gilded stone, high aspect ratio"),
    Candidate("madrid_plazamayor", "Plaza Mayor", "Spain", 40.41552, -3.70744, "closed arcaded rectangle, uniform painted render, four gated entries"),
    Candidate("krakow_rynek", "Rynek Glowny", "Poland", 50.06166, 19.93727, "very large medieval square with a free-standing hall in the middle"),
    Candidate("prague_staromestske", "Staromestske namesti", "Czechia", 50.08758, 14.42134, "irregular medieval square, gothic towers, plaster and stone mix"),
    Candidate("venice_sanmarco", "Piazza San Marco", "Italy", 45.43418, 12.33875, "car-free trapezoid, brick campanile, arcaded on three sides"),
    Candidate("london_trafalgar", "Trafalgar Square", "United Kingdom", 51.508, -0.12805, "open terraced square, Portland stone, traffic on one side"),
    Candidate("toulouse_capitole", "Place du Capitole", "France", 43.60447, 1.44422, "brick city, single monumental facade, otherwise low arcades"),
    Candidate("lisbon_comercio", "Praca do Comercio", "Portugal", 38.70751, -9.13646, "three-sided square open to water, uniform arcade, tiled render"),
    Candidate("amsterdam_dam", "Dam", "Netherlands", 52.37307, 4.89252, "narrow-fronted brick square crossed by trams"),
    Candidate("vienna_stephansplatz", "Stephansplatz", "Austria", 48.20849, 16.37301, "cathedral standing in the middle, very narrow residual square"),
    Candidate("berlin_alexanderplatz", "Alexanderplatz", "Germany", 52.52194, 13.41319, "post-war modernist plaza, curtain wall and concrete, very open"),
    Candidate("rome_navona", "Piazza Navona", "Italy", 41.89921, 12.47308, "long narrow stadium plan, baroque render, fountains"),
    Candidate("copenhagen_kongensnytorv", "Kongens Nytorv", "Denmark", 55.67854, 12.58527, "circular plaza, mixed brick and stucco, northern latitude sun"),
    Candidate("barcelona_placareial", "Placa Reial", "Spain", 41.37977, 2.17503, "small enclosed arcaded courtyard, palms, very high enclosure"),
    Candidate("istanbul_sultanahmet", "Sultanahmet Meydani", "Turkey", 41.00553, 28.97688, "wide open park square between two large domed masses"),
    Candidate("zagreb_jelacic", "Trg bana Jelacica", "Croatia", 45.81311, 15.97719, "tram-crossed square, mixed nineteenth century and modern fronts"),
    Candidate("newyork_timessquare", "Times Square", "United States", 40.75797, -73.98554, "deep glass and LED canyon, tallest aspect ratio in the set"),
    Candidate("tokyo_hachiko", "Hachiko square, Shibuya", "Japan", 35.65947, 139.70046, "dense glass canyon with a scramble crossing, heavy signage"),
    Candidate("mexico_zocalo", "Plaza de la Constitucion", "Mexico", 19.43264, -99.13321, "very large open plaza, volcanic stone, low surrounding blocks"),
    Candidate("melbourne_federation", "Federation Square", "Australia", -37.81796, 144.96907, "faceted modern facades, sandstone and zinc, southern hemisphere"),
    Candidate("singapore_raffles", "Raffles Place", "Singapore", 1.28381, 103.85152, "tropical high-rise financial core, glass towers around a small park"),
    Candidate("capetown_greenmarket", "Greenmarket Square", "South Africa", -33.92418, 18.42003, "small cobbled market square, low painted facades"),
]
