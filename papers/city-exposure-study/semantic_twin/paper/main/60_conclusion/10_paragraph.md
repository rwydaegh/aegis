...
% NEXT: The comparison is conditional on the fixed source law, scene evidence, Duke
% NEXT: body, route-tangent yaw, and first-material transport boundary. The 16-replica
