...
\begin{itemize}
  ...
  \item Test labs. CETECOM (Essen), Verkotan (Oulu). Both on IEC TC106 and IEEE ICES; both face APD test qualification at mmWave. Eurofins as brand-name fallback.
...
\begin{itemize}
  ...
  \item NPL and UKHSA (Chitnis et al.). 2025 \emph{Bioelectromagnetics} on traceable APD above 10\,GHz. UK regulator-affiliated.
...
Weeks 1 to 2.
\begin{itemize}
  \item I send the P1 letter ask to Shanshan Wang (Wiart cc), Parazzini, Sapienza (Liberti or Apollonio), Schmid, Yang Hao, Gustafsson, and to the test-lab and Orange contacts.
