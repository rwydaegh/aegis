...
| --- | --- | --- |
| `AEGIS_DATA_DIR` | CDF and exposure runners, for phantom meshes | optional machine override. Named CDF configs resolve the repository-relative data directory when it is unset |
