...
% NEXT: 32, 48, and 64. Its first 16 replicas exactly match the verified campaign
% NEXT: arrays after timing fields are removed. Mexico City route points 0, 1, and 3
% NEXT: and Tokyo Hachiko route points 13, 14, and 15 remain the six shadowed points.
% NEXT: The first-diffuse estimate is their only nonzero modeled contribution.
...
% NEXT: Hachiko. These intervals apply to each fixed route.
