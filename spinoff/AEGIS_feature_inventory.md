...
- QuaDRiGa .conf file parsing for 91 channel presets (186 parameter types) with LRU cache (max 32)
...
- 2469 test cases across 139 test files; pytest with pytest-xdist (2 workers) and Hypothesis property testing
