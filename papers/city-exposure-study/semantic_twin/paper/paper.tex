...
picture that reflection already describes. At the metre wavelengths where street
...
baselines, 2.15 people per square metre cost a median 1.4\,dB under the street
...
qualifies adjacent per-city medians.
...
The trace rejects that prediction. At 2.15 people per square metre, represented
