...
%DIF ADD v4_to_coauthors/paper.tex   Mon Aug 10 21:50:39 2026
% Paper A+B (merged)
...
R.~Wydaeghe, B.~Stroobandt, S.~Gallucci, M.~Parazzini, G.~Tognola,
  ...
  \emph{Phys. Med. Biol.}, \DIFdelbegin \DIFdel{2026, under review.
}\DIFdelend \DIFaddbegin \DIFadd{accepted for publication, 2026.
}\DIFaddend
