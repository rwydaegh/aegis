...
by 2867 bodies, the street model lost 1.4\,dB and the rooftop model lost
1.0\,dB. The ratio of losses was
...
changed by only 0.049\,dB. Its paired noise floor was 0.009\,dB, so this change
was consistent with zero. The rooftop and street noise floors were 0.035 and
0.112\,dB, which put their changes 30 and 12 times above the floor.

The absorber control separated blockage from reflection. Replacing the bodies
with index-matched absorbers changed the isotropic loss from 0.049 to 0.708\,dB,
whereas the rooftop loss changed from 1.044 to 1.332\,dB and the street loss from
1.391 to 1.607\,dB. The bodies therefore became almost invisible to isotropic
illumination because they reflected blocked power into other directions. This
paired study used six interactions with roulette from the third, which is the
superseded trace configuration. The shifts have not been rerun at the reported
three-interaction budget.
