% PREV: % claim: ten_route_production_detail
% PREV: The ten selected routes contain 163 observation points. Every route uses
% PREV: image-derived surface properties, a Duke phantom facing along the walk, 64
...
% NEXT:   \label{fig:si-ten-route-detail}
% NEXT: \end{figure*}
