...
% PREV: minimum is finite but small. The angle at which $|r_p|^2$ is
% PREV: minimized is the \textit{pseudo-Brewster angle} and satisfies
% PREV: $\theta_{\mathrm{pB}} \approx \arctan|\ntilde|$ to within $1^\circ$ for
% PREV: $|\ntilde| > 3$~\cite{Potter1970,Ohman1977}. At this angle, $T_p$
% PREV: peaks near $0.95$, while $T_s$ has fallen below $0.20$. Their
