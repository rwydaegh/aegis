...
% NEXT: The ten routes are selected case studies. Their differences do not rank the
% NEXT: ten cities and do not estimate population exposure. Each result is normalized
...
% NEXT: one body orientation that faces along the walk, one roofline transmitter model, and ten
...
and cosine factors. The maximum adjoint-versus-quadrature difference is 1.43\%
for the bounced term, and the maximum adjoint-versus-Sionna difference is 0.80\%
for total transport in that test. The same
