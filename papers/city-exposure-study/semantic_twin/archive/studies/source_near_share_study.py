...
from semantic_twin.illumination.source_studies import RANGE_EDGES_M, direct_by_range_band
from semantic_twin.illumination.sources import silhouette_cloud, thin
from semantic_twin.walk.grid import build_walk
from semantic_twin.walk.ground import measure_ground_datum

ROOT = paths.root()

EDGES_M = RANGE_EDGES_M
banded_direct = direct_by_range_band
