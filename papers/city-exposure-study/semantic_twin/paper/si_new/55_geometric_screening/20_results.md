...
% PREV: lattice within 90~m and retains 64 observation points evenly across its
% PREV: nearest-neighbor ordering. The visible roofline transmitter curve is built from
% PREV: these same 64 points. Surface properties use geometry-based priors, and the
