...
import { sampleInferno } from '@/lib/colormap'
...
export default function BodyMesh() {
  ...
  // Apply heatmap colors when sabArray changes
  useEffect(() => {
