...
% NEXT: To see why, apply Fubini's theorem to exchange the surface and direction
% NEXT: integrals. The local law~\eqref{eq:geom-law} gives
% NEXT: $\APD(\rr,\khat) = \IPD\,T_0\,\Vis(\rr,\khat)\,
% NEXT: \pospart{\nhat\cdot(-\khat)}$. The direction average of the integrand
% NEXT: is
% NEXT: \[
% NEXT:   \frac{1}{4\pi}\int_{S^2}
% NEXT:   \IPD\,T_0\,\Vis(\rr,\khat)\,\pospart{\nhat\cdot(-\khat)}\,
% NEXT:   \diff\Omega
% NEXT:   = \frac{\IPD\,T_0}{4}\,\eta(\rr)\,,
% NEXT: \]
% NEXT: using the definition of $\eta$ and the identity $\int_{S^2}
