...
% NEXT: $\hat{e}_p(\rr) = \hat{e}_s \times \khat$. Let $\EE_0 = a_s \hat{e}_s + a_p \hat{e}_p$, with the local TE and TM
% NEXT: energy fractions $|e_s|^2 = |a_s|^2 / |\EE_0|^2$ and
% NEXT: $|e_p|^2 = |a_p|^2 / |\EE_0|^2$. The effective transmission at $\rr$
% NEXT: is then
% NEXT: \begin{equation}\label{eq:Teff}
% NEXT:   \Teff(\rr) = |e_s(\rr)|^2 \, T_s(\theta) + |e_p(\rr)|^2 \,
% NEXT:   T_p(\theta)\, .
% NEXT: \end{equation}
% NEXT: The exact \gls{APD} at a visible point is therefore
