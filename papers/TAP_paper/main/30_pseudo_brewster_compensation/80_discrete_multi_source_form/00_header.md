...
% NEXT: $\khat_1, \ldots, \khat_N$ and incident power densities
% NEXT: $\IPD_1, \ldots, \IPD_N$.
% NEXT: Stack the directions column-wise into
% NEXT: $\mathbf{K} \in \mathbb{R}^{3\times N}$, with column $i$ equal to
% NEXT: $-\khat_i$. Stack the incident power densities into
% NEXT: $\bm{\mathrm{IPD}} = [\IPD_1,\ldots,\IPD_N]^\top \in \mathbb{R}^N$. Let
