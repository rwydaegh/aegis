...
- 2026-04-17 | aegis-web/src/components/panels/analysis/HeatmapCanvas.tsx:160-190 | handleMouseMove omits canvas/rect scaling that handleClick applies, so tooltip hit-test drifts when the w-full canvas renders wider than its 280px buffer (pre-existing, preserved verbatim by PR #525) | reviewer #1, run 24565798246
