"""Reference plates: one clean frontal shot per building, from the Inhouse tiles.
...
- Photogrammetry is lit flat. Inhouse tiles carry baked sun in the albedo; adding a
...
def scene_bvh(collection: str = "inhouse") -> BVHTree:
...
def setup_render(out_dir: pathlib.Path) -> None:
    ...
    # they were badly lit, they were dark because Inhouse's Ghent capture is overcast
