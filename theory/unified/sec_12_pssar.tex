...
$C_p = 1 + \sin^2\theta/\abs{\zeta}^2$ with
...
reflecting the exponential concentration of SAR near the surface. This $7.59$
figure is the shape-relaxed, any-orientation upper bound of
\cref{eq:pssar-slab}, far above the regulated 10\,g-cube value bounded in
\cref{sec:pssar-dominance}; it is a worst-case envelope, not a compliance
prediction.
