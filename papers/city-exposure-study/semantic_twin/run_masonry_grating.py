...
def harmonics_for(wall: MasonryWall, frequency_hz: float, theta_deg: float) -> tuple[int, int]:
    ...
    m_max = int(math.ceil(span * wall.cell_x_m / lam)) + 2
    n_max = int(math.ceil(span * wall.cell_y_m / lam)) + 2
    return m_max, n_max
...
def stage_kirchhoff() -> None:
    baseline = dict(format_name="standard_metric", bond_name="running", recess_m=0.005, joint_width_m=0.010)
    ...
    path = write("kirchhoff.json", payload)
...
MODEL_PRESETS = {
    "brick_masonry_uk_recessed": dict(format_name="standard_metric", joint_width_m=0.010, recess_m=0.005),
    "brick_masonry_uk_flush": dict(format_name="standard_metric", joint_width_m=0.010, recess_m=0.0),
    "brick_masonry_uk_deep_recessed": dict(format_name="standard_metric", joint_width_m=0.010, recess_m=0.010),
    "brick_masonry_waalformaat_recessed": dict(format_name="waalformaat", joint_width_m=0.010, recess_m=0.005),
    "brick_masonry_waalformaat_flush": dict(format_name="waalformaat", joint_width_m=0.010, recess_m=0.0),
    "brick_masonry_belgian_module_recessed": dict(format_name="module_m65", joint_width_m=0.012, recess_m=0.005),
    "brick_masonry_belgian_module_flush": dict(format_name="module_m65", joint_width_m=0.012, recess_m=0.0),
}
...
SPECULAR_DATASETS = {
    "landron1996_brick_4ghz_perp": dict(frequency_hz=4.0e9, polarisation="te", permittivity=4.44),
    "landron1996_brick_4ghz_par": dict(frequency_hz=4.0e9, polarisation="tm", permittivity=4.44),
    "dillard2003_brick_28ghz_perp": dict(frequency_hz=28.0e9, polarisation="te", permittivity=3.91),
}
...
def main() -> None:
    ...
    selected = stages if arguments.stage == "all" else {arguments.stage: stages[arguments.stage]}
